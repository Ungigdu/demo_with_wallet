...
const BountyCard = () => {
  ...
  const { estimatedCakeBountyReward, estimatedDollarBountyReward, totalPendingKusaHarvest } = useGetVaultBountyInfo()
  ...
  useEffect(() => {
    if (estimatedCakeBountyReward && estimatedDollarBountyReward && totalPendingKusaHarvest) {
      setBounties({
  ...
  }, [estimatedCakeBountyReward, estimatedDollarBountyReward, totalPendingKusaHarvest])
  ...
  const [onPresentBountyModal] = useModal(
    <BountyModal
      ...
      totalPendingKusaHarvest={totalPendingKusaHarvest}
      callFee={callFee}
