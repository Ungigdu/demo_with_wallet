...
import { Flex, TooltipText, IconButton, useModal, CalculateIcon, Skeleton, useTooltip } from 'components/uikit'
...
const AprRow: React.FC<AprRowProps> = ({
  ...
  const earningTokenPrice = usePriceKusaUsdt().toNumber()
  console.log("!!!!", earningTokenPrice, stakingTokenPrice)
