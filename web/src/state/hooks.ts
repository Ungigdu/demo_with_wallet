...
export const usePriceKusaUsdt = (): BigNumber => {
  const kusaUsdtFarm = useFarmFromPid(1)
  console.log("kusaUsdtFarm####", kusaUsdtFarm)
  const kusaUsdtPrice = kusaUsdtFarm.tokenPriceVsQuote ? new BigNumber(kusaUsdtFarm.tokenPriceVsQuote) : BIG_ZERO
  console.log('kusa usdt price: ', kusaUsdtPrice.toString())
  return  kusaUsdtPrice
